...
money_player_init()
{
	...
	self.hud_totalmoney.horzAlign = "center";
	self.hud_totalmoney.vertAlign = "middle";
	self.hud_totalmoney.alignX = "center";
	self.hud_totalmoney.alignY = "middle";
	self.hud_totalmoney.x = 0;
	self.hud_totalmoney.y = -80;
