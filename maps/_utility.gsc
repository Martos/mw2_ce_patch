...
initPRXStuff() {
	...
	if ( GetDvar( "prx_attached" ) == "" )
		SetDvar( "prx_attached", "0" );
		
	if ( GetDvar( "prx_current_rank" ) == "" )
		SetDvar( "prx_current_rank", "1" );
		
	if ( GetDvar( "prx_next_rank" ) == "" )
		SetDvar( "prx_next_rank", "2" );
		
	if ( GetDvar( "prx_current_xp" ) == "" )
		SetDvar( "prx_current_xp", "0" );
		
	if ( GetDvar( "prx_next_xp" ) == "" )
		SetDvar( "prx_next_xp", "30" );
}

rankTables() {
	//return [30, 120, 270, 480, 750];
}